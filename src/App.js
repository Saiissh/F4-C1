...
function App() {
  ...
  function saveHandler(){
   ...
   else if(fname.trim().length==0 || email.trim().length==0 || pass.trim().length==0 || cpass.trim().length==0)
    ...
    <div>
      <div className="project">
        ...
        <div className='right-side'>
          ...
          <input  required onChange={nameHandler} type="text" id='fname' placeholder='First Name' value={fname}/>
          <input required  onChange={emailHandler} type="email" id='email' placeholder='Email' value={email} />
          <input required  onChange={passHandler} type="password" id='pass' placeholder='Password' value={pass}/>
          <input  required onChange={cpassHandler} type="password" id='cpass' placeholder='Confirm Password' value={cpass}/>
